...
GROUP_CONCAT(DISTINCT(IF(obs_fscn.name = 'Gravida', coalesce(o.value_numeric,  o.value_text, o.value_datetime, coded_scn.name, coded_fscn.name), NULL)) ORDER BY o.obs_id DESC) AS 'Gravida',
  ...
  GROUP_CONCAT(DISTINCT(IF(obs_fscn.name = 'Still Birth ', coalesce(o.value_numeric,  o.value_text, o.value_datetime, coded_scn.name, coded_fscn.name), NULL)) ORDER BY o.obs_id DESC) AS 'Still Birth',
...
GROUP_CONCAT(DISTINCT(IF(obs_fscn.name = 'ANC Blood Group', coalesce(o.value_numeric,  o.value_text, o.value_datetime, coded_scn.name, coded_fscn.name), NULL)) ORDER BY o.obs_id DESC) AS 'Blood Group',
 GROUP_CONCAT(DISTINCT(IF(obs_fscn.name = 'ANC HIV (Elisa)', coalesce(o.value_numeric,  o.value_text, o.value_datetime, coded_scn.name, coded_fscn.name), NULL)) ORDER BY o.obs_id DESC) AS 'HIV (Elisa)',
 GROUP_CONCAT(DISTINCT(IF(obs_fscn.name = 'ANC Hep.B', coalesce(o.value_numeric,  o.value_text, o.value_datetime, coded_scn.name, coded_fscn.name), NULL)) ORDER BY o.obs_id DESC) AS 'Hep.B',
 GROUP_CONCAT(DISTINCT(IF(obs_fscn.name = 'ANC Sickle Prep', coalesce(o.value_numeric,  o.value_text, o.value_datetime, coded_scn.name, coded_fscn.name), NULL)) ORDER BY o.obs_id DESC) AS 'Sickle Prep',
 GROUP_CONCAT(DISTINCT(IF(obs_fscn.name = 'ANC VDRL', coalesce(o.value_numeric,  o.value_text, o.value_datetime, coded_scn.name, coded_fscn.name), NULL)) ORDER BY o.obs_id DESC) AS 'VDRL',
 GROUP_CONCAT(DISTINCT(IF(obs_fscn.name = 'ANC Urine M/E 1', coalesce(o.value_numeric,  o.value_text, o.value_datetime, coded_scn.name, coded_fscn.name), NULL)) ORDER BY o.obs_id DESC) AS 'Urine M/E 1',
...
GROUP_CONCAT(DISTINCT(IF(obs_fscn.name = 'ANC Template Urine M/E 1', coalesce(o.value_numeric,  o.value_text, o.value_datetime, coded_scn.name, coded_fscn.name), NULL)) ORDER BY o.obs_id DESC) AS 'Urine M/E 1',
