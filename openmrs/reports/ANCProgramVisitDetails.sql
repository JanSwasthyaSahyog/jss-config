SELECT
  ...
  GROUP_CONCAT(DISTINCT(IF(obs_fscn.name = 'ANC Template, ANC ID', coalesce(o.value_numeric, o.value_boolean, o.value_text, o.value_datetime, coded_scn.name, coded_fscn.name), NULL)) ORDER BY o.obs_id DESC) AS 'ANC ID',
  GROUP_CONCAT(DISTINCT(IF(obs_fscn.name = 'Gravida', coalesce(o.value_numeric, o.value_boolean, o.value_text, o.value_datetime, coded_scn.name, coded_fscn.name), NULL)) ORDER BY o.obs_id DESC) AS 'Gravida',
  GROUP_CONCAT(DISTINCT(IF(obs_fscn.name = 'Parity', coalesce(o.value_numeric, o.value_boolean, o.value_text, o.value_datetime, coded_scn.name, coded_fscn.name), NULL)) ORDER BY o.obs_id DESC) AS 'Parity',
  GROUP_CONCAT(DISTINCT(IF(obs_fscn.name = 'Abortion', coalesce(o.value_numeric, o.value_boolean, o.value_text, o.value_datetime, coded_scn.name, coded_fscn.name), NULL)) ORDER BY o.obs_id DESC) AS 'Abortion',
  GROUP_CONCAT(DISTINCT(IF(obs_fscn.name = 'Live Births', coalesce(o.value_numeric, o.value_boolean, o.value_text, o.value_datetime, coded_scn.name, coded_fscn.name), NULL)) ORDER BY o.obs_id DESC) AS 'Live Births',
  GROUP_CONCAT(DISTINCT(IF(obs_fscn.name = 'ANC, Last menstrual period', coalesce(o.value_numeric, o.value_boolean, o.value_text, o.value_datetime, coded_scn.name, coded_fscn.name), NULL)) ORDER BY o.obs_id DESC) AS 'LMP',
  GROUP_CONCAT(DISTINCT(IF(obs_fscn.name = 'ANC, Estimated Date of Delivery', coalesce(o.value_numeric, o.value_boolean, o.value_text, o.value_datetime, coded_scn.name, coded_fscn.name), NULL)) ORDER BY o.obs_id DESC) AS 'EDD',
  GROUP_CONCAT(DISTINCT(IF(obs_fscn.name = 'ANC, First Tetanus', coalesce(o.value_numeric, o.value_boolean, o.value_text, o.value_datetime, coded_scn.name, coded_fscn.name), NULL)) ORDER BY o.obs_id DESC) AS 'TT1',
  GROUP_CONCAT(DISTINCT(IF(obs_fscn.name = 'ANC, Second Tetanus', coalesce(o.value_numeric, o.value_boolean, o.value_text, o.value_datetime, coded_scn.name, coded_fscn.name), NULL)) ORDER BY o.obs_id DESC) AS 'TT2',
  GROUP_CONCAT(DISTINCT(IF(obs_fscn.name = 'ANC, Visit date', coalesce(o.value_numeric, o.value_boolean, o.value_text, o.value_datetime, coded_scn.name, coded_fscn.name), NULL)) ORDER BY o.obs_id DESC) AS 'Visit date',
  GROUP_CONCAT(DISTINCT(IF(obs_fscn.name = 'ANC, Follow up visit', coalesce(o.value_numeric, o.value_boolean, o.value_text, o.value_datetime, coded_scn.name, coded_fscn.name), NULL)) ORDER BY o.obs_id DESC) AS 'Follow up visit',
  ...
  GROUP_CONCAT(DISTINCT(IF(obs_fscn.name = 'Albumin (Routine Urine)', coalesce(o.value_numeric, o.value_boolean, o.value_text, o.value_datetime, coded_scn.name, coded_fscn.name), NULL)) ORDER BY o.obs_id DESC) AS 'Albumin (Routine Urine)',
  GROUP_CONCAT(DISTINCT(IF(obs_fscn.name = 'Sugar (Routine Urin)', coalesce(o.value_numeric, o.value_boolean, o.value_text, o.value_datetime, coded_scn.name, coded_fscn.name), NULL)) ORDER BY o.obs_id DESC) AS 'Sugar (Routine Urin)',
  GROUP_CONCAT(DISTINCT(IF(obs_fscn.name = 'ANC, Oedema', coalesce(o.value_numeric, o.value_boolean, o.value_text, o.value_datetime, coded_scn.name, coded_fscn.name), NULL)) ORDER BY o.obs_id DESC) AS 'Oedema',
  GROUP_CONCAT(DISTINCT(IF(obs_fscn.name = 'Haemoglobin', coalesce(o.value_numeric, o.value_boolean, o.value_text, o.value_datetime, coded_scn.name, coded_fscn.name), NULL)) ORDER BY o.obs_id DESC) AS 'Haemoglobin',
  GROUP_CONCAT(DISTINCT(IF(obs_fscn.name = 'Haemoglobin Range', coalesce(o.value_numeric, o.value_boolean, o.value_text, o.value_datetime, coded_scn.name, coded_fscn.name), NULL)) ORDER BY o.obs_id DESC) AS 'Haemoglobin Range',
  GROUP_CONCAT(DISTINCT(IF(obs_fscn.name = 'Systolic', coalesce(o.value_numeric, o.value_boolean, o.value_text, o.value_datetime, coded_scn.name, coded_fscn.name), NULL)) ORDER BY o.obs_id DESC) AS 'Systolic',
  GROUP_CONCAT(DISTINCT(IF(obs_fscn.name = 'Diastolic', coalesce(o.value_numeric, o.value_boolean, o.value_text, o.value_datetime, coded_scn.name, coded_fscn.name), NULL)) ORDER BY o.obs_id DESC) AS 'Diastolic',
  GROUP_CONCAT(DISTINCT(IF(obs_fscn.name = 'Posture', coalesce(o.value_numeric, o.value_boolean, o.value_text, o.value_datetime, coded_scn.name, coded_fscn.name), NULL)) ORDER BY o.obs_id DESC) AS 'Posture',
  GROUP_CONCAT(DISTINCT(IF(obs_fscn.name = 'ANC, Gestation', coalesce(o.value_numeric, o.value_boolean, o.value_text, o.value_datetime, coded_scn.name, coded_fscn.name), NULL)) ORDER BY o.obs_id DESC) AS 'Gestation',
  GROUP_CONCAT(DISTINCT(IF(obs_fscn.name = 'ANC, Fundal Height', coalesce(o.value_numeric, o.value_boolean, o.value_text, o.value_datetime, coded_scn.name, coded_fscn.name), NULL)) ORDER BY o.obs_id DESC) AS 'Fundal Height',
  GROUP_CONCAT(DISTINCT(IF(obs_fscn.name = 'ANC, Position', coalesce(o.value_numeric, o.value_boolean, o.value_text, o.value_datetime, coded_scn.name, coded_fscn.name), NULL)) ORDER BY o.obs_id DESC) AS 'Position',  
  GROUP_CONCAT(DISTINCT(IF(obs_fscn.name = 'ANC, Fetal Heart Sound', coalesce(o.value_numeric, o.value_boolean, o.value_text, o.value_datetime, coded_scn.name, coded_fscn.name), NULL)) ORDER BY o.obs_id DESC) AS 'FHS'
FROM obs o
