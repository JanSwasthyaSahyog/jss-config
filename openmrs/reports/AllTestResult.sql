	Select date(sample.entered_date)as date, patient_identity.identity_data as registration_number,type_of_sample.description as sample, test.name as test_name,
			(CASE
